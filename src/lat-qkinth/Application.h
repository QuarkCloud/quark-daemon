...
#ifndef LAT_QKINTH_APPLICATION_H
#define LAT_QKINTH_APPLICATION_H 1
...
public:
    ...
    bool init(const std::string& name , int maxTimes, int bufferSize);
    void final();
...
#endif /**LAT_QKINTH_APPLICATION_H*/
